  ...
  <el-dialog :title="title" :visible="dialogFormVisible" @close="outSubmit">
    ...
    <el-form ref="form" :model="form" label-width="80px" :rules="rules" label-position="right">
      ...
      <el-form-item label="性别">
        <el-radio v-model="form.staff_sex" size="mini" border label="男">男</el-radio>
        <el-radio v-model="form.staff_sex" size="mini" border label="女">女</el-radio>
      </el-form-item>
      <el-form-item label="年龄">
        <el-input-number v-model="form.staff_age" :min="16" :max="60" size="small"></el-input-number>
      </el-form-item>
      <el-form-item label="薪资">
        <el-input-number v-model="form.staff_salary" :min="2000" :max="20000" :step="100" size="small"></el-input-number>
      </el-form-item>
      <el-form-item>
...
export default {
    ...
    return {
      rules: {
        staff_name: [
          ...
          { min: 2, max: 10, message: '员工名称在 2 到 10 个字符', trigger: 'change' }
        ]
      }
    }
  },
  methods: {
    ...
    async modifyStaff(staffObj) { //修改数据
