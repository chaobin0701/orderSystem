    ...
    <div class="chartBox">
        <chart-header title="餐品销售数据分析" :volume="false">
            <template v-slot:right>
                <div class="tabs">
                    <div class="tabs-item" @click="activeName = 'day'" :class="activeName == 'day' ? 'active' : ''">
                        今天
                    </div>
                    <div class="tabs-item" @click="activeName = 'week'" :class="activeName == 'week' ? 'active' : ''">
                        本周
                    </div>
                    <div class="tabs-item" @click="activeName = 'month'" :class="activeName == 'month' ? 'active' : ''">
                        本月
                    </div>
                </div>
            </template>
        </chart-header>
        <div class="chart" ref="box" style="width: 100%; height: 90%" v-loading="isLoading"></div>
    </div>
</template>
